...
const Skills = () => {
  return (
    <div className="h-full pb-10 relative flex flex-col justify-start  py-20  font-mono text-neutral-300  ">
      <div className="flex flex-col gap-2 text-4xl md:text-6xl lg:text-7xl z-20">
        ...
        <div className="slide flex flex-row items-center justify-between">
          ...
          <span className="text-sm md:text-lg hidden">database for all</span>
        </div>
        <div className="slide flex flex-row items-center justify-between">
